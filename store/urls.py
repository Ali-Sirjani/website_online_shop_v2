...
urlpatterns = [
    ...
    path('checkout/success/', TemplateView.as_view(template_name='store/order/success.html')),
    path('checkout/fail/', TemplateView.as_view(template_name='store/order/fail.html')),
    path('checkout/again/', TemplateView.as_view(template_name='store/order/again.html')),
